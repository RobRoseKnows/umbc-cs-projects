...
<div class = "field">
<?php
//kicks the user back if there isn't a date or time selected
if($date == '' || $time =='')
{
...
else
{
	...
	//determines whether or not they care about open/available appointments
	if(isset($_POST['onlyOpen']))
	{

		//picks individual or group
	...
	//pass over if there's no matching appts
	...
	else
	{
		...
		//creates a table and posts into it in the format of
		//Appt number , day , time , location , Student Count
